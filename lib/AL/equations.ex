defmodule AL.Equations do
  ...
  def check(name, a, b),
    do: [quote(do: is(unquote(v(name)), unquote(a))), quote(do: is(unquote(v(name)), unquote(b)))]
  ...
  defp descend(target, _leaf, acc, _tag), do: [quote(do: is(unquote(v(target)), unquote(acc)))]
