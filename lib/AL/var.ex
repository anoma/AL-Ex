defmodule AL.Var do
  ...
  @spec var(String.t() | atom()) :: var()
  def var(x) do
    :"$#{x}"
  end

  @spec name(var()) :: String.t()
  def name(x) do
  ...
  @spec find_vars(t()) :: MapSet.t(var())
  @spec find_vars(t(), MapSet.t(var())) :: MapSet.t(var())
  def find_vars(d) do
